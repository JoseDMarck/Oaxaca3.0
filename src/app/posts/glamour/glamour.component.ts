...
@Component({
  selector: 'app-glamour',
  templateUrl: './glamour.component.html',
  styleUrls: ['./glamour.component.css'],
  animations: [
...
export class GlamourComponent implements OnInit {
...
onScroll () {
 ...
 LoadMorePosts( numero){
   ...
   console.log("numero load more "+ numero)
    this.postsService
      .LoadMorePostsServicebyCategory(41, numero)
      .subscribe(res => {
        this.posts = res;
