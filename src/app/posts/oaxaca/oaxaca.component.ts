...
@Component({
  selector: 'app-oaxaca',
  templateUrl: './oaxaca.component.html',
  styleUrls: ['./oaxaca.component.css'],
  animations: [
...
export class OaxacaComponent implements OnInit {
...
onScroll () {
 ...
 LoadMorePosts( numero){
   ...
   console.log("numero load more "+ numero)
    this.postsService
      .LoadMorePostsServicebyCategory(45, numero)
      .subscribe(res => {
        this.posts = res;
